...
public class RedBlackNode {
	 ...
	 */
	RedBlackNode(String data, int index, int color, RedBlackNode p, RedBlackNode lc, RedBlackNode rc){
		this.data = data;
		this.index = index;
		this.color = color;
		this.p = p;
	...
	/**
	 * get the index of the node<br>
	 * pre-condtion: none<br>
	 * post-condition: return the index of the node<br>
